...
# Buffered logging class. used in high-speed components. i.e. TTY's
                ...
                if item in bool_names:
                    ...
                    try:
                        ...
                        print(
                            ...
                            ": setting '" +
                            item +
                            "' did not specify a valid integer.\n    Using default.")
...
def loadtrom(
    ...
    for filenameg in [fname, fname + ext.lower(), fname + ext.upper()]:
        ...
        if recurret is not None:
            return (open(recurret, "r"))
    if exitonfail:
        sys.exit(exitmsg)
    else:
        return None
# same as loadtrom, but returns path. also used for other file types. i.e.
